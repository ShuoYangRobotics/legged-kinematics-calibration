function[]= draw_robot_stance(fig, state, param, color_factor)
% input state
%  1 2 3     4  5  6  7 
% position    orientation 
    ...
    R_re =   [ cos(yaw_ang)  -sin(yaw_ang)    0;
    ...
    % draw body
    draw_cube(fig, t_ec, R_ec,param.vis_bl,param.vis_bw,param.vis_bh,color_factor*[1 0 1])
