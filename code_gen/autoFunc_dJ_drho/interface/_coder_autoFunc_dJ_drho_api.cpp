...
emlrtContext emlrtContextGlobal{
    ...
    "autoFunc_dJ_drho",                                   // fFunctionName
...
void autoFunc_dJ_drho_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  ...
  dJ_drho = (real_T(*)[9])mxMalloc(sizeof(real_T[9]));
  ...
  autoFunc_dJ_drho(*in1, lc, *in3, *dJ_drho);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*dJ_drho);
}
...
void autoFunc_dJ_drho_atexit()
{
  ...
  autoFunc_dJ_drho_xil_terminate();
  autoFunc_dJ_drho_xil_shutdown();
...
//
// File trailer for _coder_autoFunc_dJ_drho_api.cpp
//
// [EOF]
//
