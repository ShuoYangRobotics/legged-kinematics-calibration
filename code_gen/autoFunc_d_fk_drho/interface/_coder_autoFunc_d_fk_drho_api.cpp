...
// File: _coder_autoFunc_d_fk_drho_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "autoFunc_d_fk_drho",                                 // fFunctionName
...
void autoFunc_d_fk_drho_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  ...
  d_fk_drho = (real_T(*)[3])mxMalloc(sizeof(real_T[3]));
  ...
  autoFunc_d_fk_drho(*in1, lc, *in3, *d_fk_drho);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*d_fk_drho);
}
...
void autoFunc_d_fk_drho_atexit()
{
  ...
  autoFunc_d_fk_drho_xil_terminate();
  autoFunc_d_fk_drho_xil_shutdown();
...
//
// File trailer for _coder_autoFunc_d_fk_drho_api.cpp
//
// [EOF]
//
