...
// File: _coder_autoFunc_d_fk_dt_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "autoFunc_d_fk_dt",                                   // fFunctionName
...
void autoFunc_d_fk_dt_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  ...
  autoFunc_d_fk_dt(*in1, lc, *in3, *jacobian);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*jacobian);
}
...
void autoFunc_d_fk_dt_atexit()
{
  ...
  autoFunc_d_fk_dt_xil_terminate();
  autoFunc_d_fk_dt_xil_shutdown();
...
//
// File trailer for _coder_autoFunc_d_fk_dt_api.cpp
//
// [EOF]
//
