...
// File: _coder_autoFunc_d_fk_ddrho_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "autoFunc_d_fk_ddrho",                                // fFunctionName
...
// Return Type  : void
//
void autoFunc_d_fk_ddrho_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
  ...
  d_fk_ddrho = (real_T(*)[3])mxMalloc(sizeof(real_T[3]));
  ...
  autoFunc_d_fk_ddrho(*in1, lc, *in3, *d_fk_ddrho);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*d_fk_ddrho);
}
...
void autoFunc_d_fk_ddrho_atexit()
{
  ...
  autoFunc_d_fk_ddrho_xil_terminate();
  autoFunc_d_fk_ddrho_xil_shutdown();
...
//
// File trailer for _coder_autoFunc_d_fk_ddrho_api.cpp
//
// [EOF]
//
