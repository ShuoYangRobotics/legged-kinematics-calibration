...
// File: _coder_autoFunc_dJ_dt_api.cpp
//
...
static const mxArray *emlrt_marshallOut(const real_T u[27]);
...
void autoFunc_dJ_dt_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  ...
  autoFunc_dJ_dt(*in1, lc, *in3, *dJ_dq);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*dJ_dq);
}
...
void autoFunc_dJ_dt_atexit()
{
  ...
  autoFunc_dJ_dt_xil_terminate();
  autoFunc_dJ_dt_xil_shutdown();
...
//
// File trailer for _coder_autoFunc_dJ_dt_api.cpp
//
// [EOF]
//
