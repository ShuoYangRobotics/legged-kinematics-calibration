...
param.rho_opt_true(:,1) = [param.lt;param.lc];
param.rho_opt_true(:,2) = [param.lt;param.lc];
param.rho_opt_true(:,3) = [param.lt;param.lc];
param.rho_opt_true(:,4) = [param.lt;param.lc];

param.rho_opt_init = zeros(param.rho_opt_size,4);
param.rho_opt_init(:,1) = [param.lt;param.lc]+0.1*randn(2,1);
param.rho_opt_init(:,2) = [param.lt;param.lc]+0.1*randn(2,1);
param.rho_opt_init(:,3) = [param.lt;param.lc]+0.1*randn(2,1);
param.rho_opt_init(:,4) = [param.lt;param.lc]+0.1*randn(2,1);
