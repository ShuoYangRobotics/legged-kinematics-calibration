...
%     -    cx cy cz, the foot center to foot contact point vector   
...
param.rho_opt_true(:,1) = [0;0;0;param.ox(1);param.oy(1);param.lt; param.lc];
param.rho_opt_true(:,2) = [0;0;0;param.ox(2);param.oy(2);param.lt; param.lc];
param.rho_opt_true(:,3) = [0;0;0;param.ox(3);param.oy(3);param.lt; param.lc];
param.rho_opt_true(:,4) = [0;0;0;param.ox(4);param.oy(4);param.lt; param.lc];

param.rho_opt_init = zeros(param.rho_opt_size,4);
param.rho_opt_init(:,1) = [0.1*randn(3,1);param.ox(1);param.oy(1);param.lt; param.lc];
param.rho_opt_init(:,2) = [0.1*randn(3,1);param.ox(2);param.oy(2);param.lt; param.lc];
param.rho_opt_init(:,3) = [0.1*randn(3,1);param.ox(3);param.oy(3);param.lt; param.lc];
param.rho_opt_init(:,4) = [0.1*randn(3,1);param.ox(4);param.oy(4);param.lt; param.lc];
