...
param.rho_opt_true(:,1) = [param.lt;param.lc;0;0;0];
param.rho_opt_true(:,2) = [param.lt;param.lc;0;0;0];
param.rho_opt_true(:,3) = [param.lt;param.lc;0;0;0];
param.rho_opt_true(:,4) = [param.lt;param.lc;0;0;0];

param.rho_opt_init = zeros(param.rho_opt_size,4);
param.rho_opt_init(:,1) = [param.lt;param.lc;0;0;0]+0.1*randn(5,1);
param.rho_opt_init(:,2) = [param.lt;param.lc;0;0;0]+0.1*randn(5,1);
param.rho_opt_init(:,3) = [param.lt;param.lc;0;0;0]+0.1*randn(5,1);
param.rho_opt_init(:,4) = [param.lt;param.lc;0;0;0]+0.1*randn(5,1);

param.rho_fix = zeros(param.rho_fix_size,4);
param.rho_fix(:,1) = [param.ox(1);param.oy(1);param.d(1)];
param.rho_fix(:,2) = [param.ox(2);param.oy(2);param.d(2)];
