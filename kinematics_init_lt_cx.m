...
%% C++ code generation
codegen autoFunc_fk_pf_pos  -lang:c++ -config:lib -args {ones(3,1), 1.0, ones(5,1)} -d code_gen/autoFunc_fk_pf_pos
codegen autoFunc_d_fk_dt    -lang:c++ -config:lib -args {ones(3,1), 1.0, ones(5,1)} -d code_gen/autoFunc_d_fk_dt
codegen autoFunc_d_fk_drho  -lang:c++ -config:lib -args {ones(3,1), 1.0, ones(5,1)} -d code_gen/autoFunc_d_fk_drho
codegen autoFunc_d_fk_ddrho -lang:c++ -config:lib -args {ones(3,1), 1.0, ones(5,1)} -d code_gen/autoFunc_d_fk_ddrho
codegen autoFunc_dJ_dt      -lang:c++ -config:lib -args {ones(3,1), 1.0, ones(5,1)} -d code_gen/autoFunc_dJ_dt
codegen autoFunc_dJ_drho    -lang:c++ -config:lib -args {ones(3,1), 1.0, ones(5,1)} -d code_gen/autoFunc_dJ_drho
...
param.rho_opt_true = zeros(param.rho_opt_size,1);
param.rho_opt_true(:,1) = [0.01];
param.rho_opt_true(:,2) = [-0.02];
param.rho_opt_true(:,3) = [-0.03];
param.rho_opt_true(:,4) = [0.04];

param.rho_opt_init = zeros(param.rho_opt_size,1);
param.rho_opt_init(:,1) = [0]+0.01*randn(1,1);
param.rho_opt_init(:,2) = [0]+0.01*randn(1,1);
param.rho_opt_init(:,3) = [0]+0.01*randn(1,1);
param.rho_opt_init(:,4) = [0]+0.01*randn(1,1);
